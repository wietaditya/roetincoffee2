...
<html lang="en">
    <head>
        ...
        <title>Roetin Coffee | pembayaran berhasil</title>
                ...
                <div class="row">
                    <div class="col-xl-12 mx-auto">
                        <div class="bg-faded text-center rounded p-2">
							<h4>Terima kasih, pesananmu akan segera diproses oleh admin :)</h4>
							<a href="#" class="btn btn-sm btn-success">Hubungi kami</a>
                        </div>
                    </div>
                </div>
            </div>
