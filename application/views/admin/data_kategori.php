...
<head>
    ...
    <title>Roetin Coffee - Data Kategori</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
						...
						<button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambah_kategori">
					...
					<div class="row">
						<table class="table table-bordered table-hover table-striped">
							...
							<tr>
								...
								<td><?= $kat->desc ?></td>
								<td>
									<a href="<?php echo base_url().'admin/edit_kategori/'. $kat->id?>" class="btn btn-sm btn-success">Edit</a>
									<a href="<?php echo base_url().'admin/delete_kategori/'. $kat->id?>" class="btn btn-sm btn-danger">Delete</a>
								</td>
							</tr>
							<?php $no++; endforeach; ?>
						</table>
